...
$(function () {
    ...
    // 复制按钮
    var $copyIcon = $('<i class="icon icon-copy code_copy" title="复制代码" aria-hidden="true"></i>');
    ...
    // 代码块收缩
    $(function () {
        var $code_expand = $('<i class="icon icon-chevron-down code-expand" title="折叠代码" aria-hidden="true"></i>');
